...
This project is a simplified PyTorch implementation of the paper [An Image is Worth 16x16 Words: Transformers for Image Recognition at Scale](https://arxiv.org/abs/2010.11929). The main objective is to provide an easy-to-understand and concise version of the Vision Transformer (ViT) model, making it accessible for learning and experimentation.
...
These visualizations are generated using the notebook `ViT.ipynb`.
